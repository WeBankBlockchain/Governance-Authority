...
public class RemoveFunctionFromGroupHandler {
    ...
    public void request(String contract, String function, String group) throws Exception{
        TxReceiptUtils.ensureTxSucceed(this.authManager.requestRemoveFunctionFromGroup(contract, function, group));
    }

    public void confirm() throws Exception{
        TxReceiptUtils.ensureTxSucceed(this.authManager.approveSingle(AuthConstants.REMOVE_FUNCTION_FROM_GROUP));
    }

    public void execute() throws Exception{
        TxReceiptUtils.ensureTxSucceed(this.authManager.executeRemoveFunctionFromGroup());
    }

    public void delete() throws Exception{
        TxReceiptUtils.ensureTxSucceed(this.authManager.deleteSingle(AuthConstants.REMOVE_FUNCTION_FROM_GROUP));
    }
    ...
    public RequestInfo getRequest() throws Exception{
        Tuple7<BigInteger, String, BigInteger, String, BigInteger, BigInteger, BigInteger> request =
                this.authManager.getRequestSingle(AuthConstants.REMOVE_FUNCTION_FROM_GROUP);
    ...
    public RemoveFunctionFromGroupParam getDetail() throws Exception{
        Tuple3<String, String, String> tuple = this.authManager.viewRemoveFunctionToGroup();
